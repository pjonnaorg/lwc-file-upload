...
function createLegacyAdapter(adapterId, spy) {
    wireService.register(adapterId, (wiredEventTarget) => {
        const instance = {
            emit(value) {
                wiredEventTarget.dispatchEvent(new wireService.ValueChangedEvent(value));
            }
        };
